...
public class ExamenSubprogramasJaviv1{
					...
					switch (opcionsub){
						...
						do{
							//CompararFechas
								...
								//Comparaciónfechas
								resultado=SubprogramasJaviv1.comparacionFechas(diax,mesx,anyox,diay,mesy,anyoy);
								//MostrarResultados
								if (resultado==1){
									System.out.println("La primera fecha es la mayor");
								}else{
									if (resultado==-1)
									System.out.println("La primera fecha es la menor");
									else
						...
						do{
							//SiguienteFecha
								...
								(diax>28 && mesx==2 && (anyox%4!=0 || (anyox%100==0 && anyox%400!=0)))
								 ...
								 SubprogramasJaviv1.calcularSiguienteFecha(diax,mesx,anyox);
							//PreguntarRepetir
							System.out.println("Quieres volver a ejecutar?(S/N)");
							repetir=Character.toUpperCase(teclado.next().charAt(0));
						}
					...
					switch (opcionsub){
						...
						do{
							//PintarPiramide
								...
								//DibujarPirámide
								SubprogramasJaviv1.dibujarPiramide(tamaniopiramide,imprimible);
							//PreguntarRepetir
							System.out.println("Quieres volver a ejecutar?(S/N)");
							repetir=Character.toUpperCase(teclado.next().charAt(0));
						}
						...
						do{
							//PintarCuadrado
							SubprogramasJaviv1.dibujarCuadrado();
							//PreguntarRepetir
							System.out.println("Quieres volver a ejecutar?(S/N)");
							repetir=Character.toUpperCase(teclado.next().charAt(0));
						}
